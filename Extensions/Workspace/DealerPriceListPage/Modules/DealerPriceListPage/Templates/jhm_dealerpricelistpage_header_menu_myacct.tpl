...
<ul class="header-menu-myaccount">
    ...
    <li class="header-menu-myaccount-item-level2" data-permissions="transactions.tranEstimate.2">
        <a class="header-menu-myaccount-anchor-level3 fake-level-2" tabindex="-1" href="#" data-touchpoint="customercenter" data-hashtag="#dealer-price-lists" name="dealer-price-list-page">
